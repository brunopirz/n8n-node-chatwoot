...
import {
	...
	chatwootSingulHubOnlyOperation
...
const inboxFields: INodeProperties[] = [
	{
		...chatwootSingulHubOnlyOperation('On WhatsApp'),
		displayOptions: {
			show: {
				...showOnlyForInbox,
	...
	{
		...chatwootSingulHubOnlyOperation('WhatsApp Disconnect'),
		displayOptions: {
			show: {
				...showOnlyForInbox,
	...
	{
		...chatwootSingulHubOnlyOperation('WhatsApp Get QR Code'),
		displayOptions: {
			show: {
				...showOnlyForInbox,
